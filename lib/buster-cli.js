...
module.exports = {
    ...
    get helpOpt() {
        return this._helpOpt || (this._helpOpt = createHelpOption.call(this));
    }
};

function createHelpOption() {
    var helpOpt = this.opt("-h", "--help", "Shows this message.");
...
function printTopicHelp() {
    ...
    if (topic in this.helpTopics) {
        ...
        this.logger.log("The topic '" + topic + "' does not exist. "
                        + "Valid topics are: "
